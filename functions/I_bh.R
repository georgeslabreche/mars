...
#     #   If you do not do this then you will calculate insolation for a
#     #   negative sunset hour angle, i.e. when the sun is below the horizon.
#     if(omega_start < omega_sr){
#       omega_start = omega_sr
#     }
# 
#     # Be careful to cap the end hour angle to that of the sunset hour angle.
#     #   If you do not do this then you will calculate insolation for a
#     #   negative sunset hour angle, i.e. when the sun is below the horizon.
#     if(omega_end > omega_ss){
#       omega_end = omega_ss
#     }
# 
...
# 
#     # The interand for Equation 19 (1990).
#     interand = function(omega_deg){
#       omega_rad = omega_deg * pi/180
# 
#       a = (12/pi) * Gob_eq(Ls)
#       b = sin(phi) * sin(delta) + cos(phi) * cos(delta) * cos(omega_rad)
#       c = exp(-tau / b)
# 
#       a * b * c
#     }
# 
#     # Equation 19 (1990): Beam hourly insolation on Mars horizontal surface.
#     I_bh_inter = integrate(interand, omega_start, omega_end)
#     I_bh = I_bh_inter$value
#   }
# 
#   return(I_bh)
# }
